    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm fixed-top">
        <div class="container">
            <div class="row w-100 flex-sm-row menu-row">
                ...
                <div class="col-md-9 col-sm-9 d-flex airmail-menu-right">
                    <div class="collapse navbar-collapse menu-column" id="navbarSupportedContent">
                        <!-- Right Side Of Navbar -->
                        <ul class="navbar-nav  airmail-main-menu ms-auto">
