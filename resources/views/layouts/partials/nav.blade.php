...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto main-menu text-primary">
                <li class="nav-item mx-1"><a class="nav-link @if(Request::url() === url('/')) active @endif" href="{{ url('/') }}">Home</a></li>
                <li class="nav-item mx-1 dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Services
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item @if(Request::url() === route('airmail.home')) active @endif" href="{{route('airmail.home')}}">Air Mail</a></li>
                ...
                <li class="nav-item mx-1"><a class="nav-link" href="#">About Us</a></li>

                <!-- Authentication Links -->
                @guest
                    @if (Route::has('login'))
                        <li class="nav-item mx-1"><a class="nav-link" href="{{ route('login') }}">Register/Sign In</a></li>
                    @endif
                @else
                    <li class="nav-item mx-1 dropdown">
