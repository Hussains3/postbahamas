    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                @if (Auth::user()->photo)
                <img class="img-profile rounded-circle" src="{{asset(Auth::user()->photo)}}" alt="User Image" id="user-photo">
                @else
                <img class="img-profile rounded-circle" src="{{asset('staticimages/noimage.png')}}" alt="User Image" id="user-photo">
                @endif
            </a>
