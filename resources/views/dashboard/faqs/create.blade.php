...
<div class="row">
    <h1 class="fs-5">Add FAQ</h1>
</div>
<div class="row d-flex justify-content-center">
    <div class="col-md-6">

        <div class="card p-3">
            <form action="{{route('faqs.store')}}" method="post" id="">
                @csrf
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="question" id="question" cols="30" rows="2" maxlength="1000"></textarea>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-sm-3 col-form-label">Answer<span class="text-danger">*</span></label>
                    <div class="col-sm-9">
                        <textarea class="form-control" name="answer" id="answer" cols="30" rows="2" maxlength="1000"></textarea>
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-8"></div>
